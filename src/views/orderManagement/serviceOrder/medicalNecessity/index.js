          ...
          <div className="p-8" ref={componentRef}>
              ...
              <div className="py-4 mb-2">
                ...
                <div className="overflow-visible border-y border-black">
                  {values?.icd?.map((item, index) => (
                    <div key={index} className="flex">
                      <div className={`flex flex-col border-r border-black`}>
                        {index === 0 && <label className="p-2 text-black font-medium border-b border-black">ICD</label>}
                        <div className={`p-2 ${index !== values?.icd?.length - 1 ? 'border-b border-black' : ''}`}>
                          <Input
                            name={'code'}
                            placeholder="ICD"
                            className="w-[100px]"
                      ...
                      <div className={`flex flex-col justify-between flex-1`}>
                        {index === 0 && <label className="p-2 text-black font-medium border-b border-black">Description</label>}
                        <div className={`p-2 ${index !== values?.icd?.length - 1 ? 'border-b border-black' : ''}`}>
                          <Input
                            name={'description'}
                            placeholder=""
            ...
            {/* <div className="text-[20px] text-center mb-4 border-b border-black">
              ...
              <div className="text-black my-5">
                ...
                proper fit and function are appropriate for this patient and
